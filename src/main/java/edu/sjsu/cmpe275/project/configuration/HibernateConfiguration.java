...
@ComponentScan({ "edu.sjsu.cmpe275.project.configuration" })
...
//	}
	...
	private Properties hibernateProperties() {
		...
		properties.setProperty("javax.persistence.validation.mode", environment.getProperty("javax.persistence.validation.mode"));
		return properties;
	}
...
//	}
	...
	protected Properties additionalProperties() {
		...
		hibernateProperties.setProperty("hibernate.connection.charSet", environment.getProperty("hibernate.connection.charSet"));
